...
if(privatedebug){console.log("%c[[ "+"%cfrickShow.js "+"%cLoaded Properly "+"%c]]", "color:red; font-weight: bold;", "color: darkGreen; font-weight: bold;", "color:purple; font-weight: bold;", "color:red; font-weight: bold;");}
...
function makeFrickShow(id, slides, init, intervaltime, debug){
  ...
  if(isString && isNumber && isBool){
    ...
    for(var i = 1; i <= slides; i++){
      ...
      temp.setAttribute("src1", ""+id+"/"+id+""+i.toString()+".png");
