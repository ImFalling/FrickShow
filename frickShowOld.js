...
function makeFrickShow(id, slides, init, intervaltime, debug){
  console.log("%c[[ "+"%cfrickShow.js 1.0.16 "+"%cLoaded Properly "+"%c]]", "color:red; font-weight: bold;", "color: darkGreen; font-weight: bold;", "color:purple; font-weight: bold;", "color:red; font-weight: bold;");
